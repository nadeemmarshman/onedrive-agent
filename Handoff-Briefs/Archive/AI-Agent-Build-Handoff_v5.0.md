...
- GitHub repo: ✅ current — `github.com/nadeemmarshman/onedrive-agent`, currently **Private**. Phase 5 artefacts pending commit (see next steps below).
...
- **Resume and LinkedIn** — three bullet versions drafted (Delivery Lead
  primary, BA, PM — short and long forms each). Saved as
  `Resume_Bullets_OneDrive_Agent.docx` in Career Documents. Continue
  in the Job Search — Resume & LinkedIn Claude project.
